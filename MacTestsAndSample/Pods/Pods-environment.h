...
#define COCOAPODS_VERSION_MINOR_SHFastEnumerationProtocols 4
...
#define COCOAPODS_VERSION_MINOR_SHFoundationAdditions 4
...
#define COCOAPODS_VERSION_PATCH_SHInvocation 1
